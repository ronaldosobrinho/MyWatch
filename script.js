...
function trocarTamanho(){
    //atualizar a variavel de controle do tamanho da caixa
    const idOpcaoSelecionada = document.querySelector('[name="opcao-tamanho"]:checked').id;
    tamanhoSelecionado = idOpcaoSelecionada.charAt(0);
    //mudar o título do produto
    tituloProduto.innerText = "Pulseira loop esportiva " + opcoesCores[corSelecionada].pasta + " para caixa de " + opcoesTamanho[tamanhoSelecionado]; 
    //mudar o tamanho da imagem de acordro com a opção
